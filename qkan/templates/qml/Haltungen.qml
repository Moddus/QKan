...
<qgis simplifyDrawingHints="0" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" labelsEnabled="1" simplifyDrawingTol="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Notes" readOnly="0" maxScale="1" version="3.22.16-Białowieża" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{228d5431-8f44-40a0-9f32-4ab249f2b5b8}">
      <rule scalemaxdenom="500" key="{7a315328-c986-4768-8f34-85184ac94014}" label=">1:500">
        <rule filter="&quot;entwart&quot; = 'Mischwasser'" symbol="0" key="{90add3db-d470-469a-aa61-fb145e19656f}" label="Mischwasser"/>
        <rule filter="&quot;entwart&quot; = 'Regenwasser'" symbol="1" key="{70bf1df3-eafd-463d-b68e-c0f640e20674}" label="Regenwasser"/>
        <rule filter="&quot;entwart&quot; = 'Schmutzwasser'" symbol="2" key="{e7360ab6-96c3-4d12-bb06-015e14a1d486}" label="Schmutzwasser"/>
        <rule filter="&quot;entwart&quot; = 'Rinnen/Gräben'" symbol="3" key="{07e8a2eb-9665-435c-8e87-2c69926e09ac}" label="Rinnen/Gräben"/>
        <rule filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" symbol="4" key="{27ab1c10-b535-4e51-ae40-b7c256e6bd00}" label="stillgelegt"/>
        <rule filter="ELSE" description="sonstige" symbol="5" key="{783b79a0-fe47-4163-a434-b1e06b96cacd}" label="sonstige"/>
      </rule>
      <rule scalemaxdenom="10000" scalemindenom="500" key="{e05438f5-a656-42d1-ac7f-8028b529f31d}" label=">1:10000">
        <rule filter="&quot;entwart&quot; = 'Mischwasser'" symbol="6" key="{1660e41a-bcee-4000-851b-4ffbd84f067b}" label="Mischwasser"/>
        <rule filter="&quot;entwart&quot; = 'Regenwasser'" symbol="7" key="{6b527d4e-ae32-40c2-8dfc-07c45c96098b}" label="Regenwasser"/>
        <rule filter="&quot;entwart&quot; = 'Schmutzwasser'" symbol="8" key="{e5931154-729e-447c-9f78-f9ab4891db9b}" label="Schmutzwasser"/>
        <rule filter="&quot;entwart&quot; = 'Rinnen/Gräben'" symbol="9" key="{0c427e9f-b674-46d8-b28a-0b704f7beffb}" label="Rinnen/Gräben"/>
        <rule filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" symbol="10" key="{fc37676f-3d16-410e-84a2-40bf9ccf47d0}" label="stillgelegt"/>
        <rule filter="ELSE" description="sonstige" symbol="11" key="{dc84e2e3-93cd-49f9-ac6a-c1b72754a900}" label="sonstige"/>
      </rule>
      <rule filter="True" scalemindenom="10000" description="weit entfernt" symbol="12" key="{2d10dc81-3792-478e-9fdb-6ab4a4cb14f1}" label="diverse"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  ...
                  <Option value="1.1 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="1 + 4 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="size">
                      <Option value="true" type="bool" name="active"/>
                      <Option value="2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                      <Option value="3" type="int" name="type"/>
                    </Option>
                  </Option>
                  <Option value="collection" type="QString" name="type"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="1" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@1@2" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="10" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@10@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="size">
                      <Option value="true" type="bool" name="active"/>
                      <Option value="0.6 + 3 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                      <Option value="3" type="int" name="type"/>
                    </Option>
                  </Option>
                  <Option value="collection" type="QString" name="type"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="11" alpha="1">
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="0.44 + 2.2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="0.4 + 2 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@11@2" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="2" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@2@2" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="4" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="interval">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="4 * if(coalesce(breite, 0) = 0,coalesce(hoehe, 1), breite)/1000.0" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
                <Option type="Map" name="outlineWidth">
                  <Option value="false" type="bool" name="active"/>
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@4@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="5" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@5@2" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="6" alpha="1">
        ...
        <layer enabled="1" class="SimpleLine" pass="1" locked="0">
          <Option type="Map">
            ...
            <Option value="5;2;2;2" type="QString" name="customdash"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="customdash_map_unit_scale"/>
            <Option value="MM" type="QString" name="customdash_unit"/>
            <Option value="0" type="QString" name="dash_pattern_offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="dash_pattern_offset_map_unit_scale"/>
            ...
            <Option value="174,0,254,255" type="QString" name="line_color"/>
            <Option value="solid" type="QString" name="line_style"/>
            <Option value="1" type="QString" name="line_width"/>
            <Option value="MM" type="QString" name="line_width_unit"/>
            <Option value="0" type="QString" name="offset"/>
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@6@1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="7" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@7@1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" force_rhr="0" clip_to_extent="1" name="8" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" pass="2" locked="0">
          ...
          <symbol type="marker" force_rhr="0" clip_to_extent="1" name="@8@1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
    ...
    <rules key="{a2402fd8-07fc-42fe-bb93-e1e33db272b7}">
      <rule scalemaxdenom="1000" description="Beschriftung Kreisquerschnitt 1:1000" key="{9986f6b5-8a02-4bef-a6e8-d5aea04bb75d}">
        <settings calloutType="simple">
          ...
          <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" placement="2" lineAnchorPercent="0.5" centroidWhole="0" offsetUnits="MapUnit" repeatDistance="0" geometryGenerator="" maxCurvedCharAngleOut="-20" preserveRotation="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" layerType="LineGeometry" fitInPolygonOnly="0" maxCurvedCharAngleIn="20" geometryGeneratorEnabled="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="5" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" rotationAngle="0" dist="2" yOffset="0" quadOffset="4" overrunDistance="0"/>
          <rendering displayAll="0" limitNumLabels="0" drawLabels="1" maxNumLabels="2000" obstacleFactor="1" scaleMax="5000" obstacle="1" mergeLines="0" fontMinPixelSize="3" unplacedVisibility="0" obstacleType="0" fontMaxPixelSize="10000" minFeatureSize="0" zIndex="0" fontLimitPixelSize="0" scaleMin="1" upsidedownLabels="0" labelPerPart="0" scaleVisibility="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option name="properties"/>
      ...
      <rule scalemaxdenom="2500" scalemindenom="1000" description="Beschriftung Kreisquerschnitt 1:2500" key="{2f4c978a-302d-4477-bd60-714fcd2778c5}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" namedStyle="Regular" isExpression="0" fontUnderline="0" fontStrikeout="0" fontKerning="1" blendMode="0" allowHtml="0" textOpacity="1" textColor="50,50,50,255" multilineHeight="1" fontWordSpacing="0" fontWeight="50" fontItalic="0" fontFamily="MS Shell Dlg 2" capitalization="0" fontLetterSpacing="0" fieldName="haltnam" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSize="10">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.80000000000000004" bufferColor="250,250,250,255" bufferSizeUnits="MM" bufferNoFill="1" bufferDraw="1" bufferOpacity="1"/>
            <text-mask maskType="0" maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="0" maskSizeUnits="MM" maskJoinStyle="128" maskedSymbolLayers=""/>
          ...
          <text-format autoWrapLength="0" placeDirectionSymbol="0" addDirectionSymbol="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" plussign="0" useMaxLineLengthForAutoWrap="1" wrapChar="" formatNumbers="0" leftDirectionSymbol="&lt;" multilineAlign="0" decimals="3"/>
          <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" placement="2" lineAnchorPercent="0.5" centroidWhole="0" offsetUnits="MM" repeatDistance="0" geometryGenerator="" maxCurvedCharAngleOut="-25" preserveRotation="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" layerType="LineGeometry" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="5" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" rotationAngle="0" dist="0" yOffset="0" quadOffset="4" overrunDistance="0"/>
  ...
  <aliases>
    ...
    <alias index="1" name="Bezeichnung" field="haltnam"/>
    ...
    <alias index="7" name="Außendurchmesser" field="aussendurchmesser"/>
    <alias index="8" name="Sohlhöhe Anfang" field="sohleoben"/>
    <alias index="9" name="Sohlhöhe Ende" field="sohleunten"/>
    <alias index="10" name="Baujahr" field="baujahr"/>
    <alias index="11" name="Eigentümer" field="eigentum"/>
    <alias index="12" name="Teilgebiet" field="teilgebiet"/>
    <alias index="13" name="Straße" field="strasse"/>
    ...
    <alias index="17" name="Profilauskleidung" field="profilauskleidung"/>
    <alias index="18" name="Innenmaterial" field="innenmaterial"/>
    <alias index="19" name="Rauheitsbeiwert" field="ks"/>
    <alias index="20" name="Elementtyp" field="haltungstyp"/>
    <alias index="21" name="Planungsstatus" field="simstatus"/>
    <alias index="22" name="Transporthaltung" field="transport"/>
    <alias index="23" name="" field="druckdicht"/>
    <alias index="24" name="x Anfang" field="xschob"/>
    <alias index="25" name="y Anfang" field="yschob"/>
    <alias index="26" name="x Ende" field="xschun"/>
    <alias index="27" name="y Ende" field="yschun"/>
    <alias index="28" name="Kommentar" field="kommentar"/>
    <alias index="29" name="erstellt" field="createdat"/>
  </aliases>
  <defaults>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" width="100" hidden="0" name="innenmaterial"/>
      ...
      <column type="field" width="170" hidden="0" name="entwart"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="netztyp"/>
