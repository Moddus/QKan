...
<qgis simplifyDrawingHints="0" minScale="100000000" simplifyAlgorithm="0" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" labelsEnabled="1" simplifyDrawingTol="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Notes" readOnly="0" maxScale="0" version="3.22.16-Białowieża" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" namedStyle="Bold" isExpression="0" fontUnderline="1" fontStrikeout="0" fontKerning="1" blendMode="0" allowHtml="0" textOpacity="1" textColor="113,114,113,255" multilineHeight="1" fontWordSpacing="0" fontWeight="75" fontItalic="0" fontFamily="MS Shell Dlg 2" capitalization="0" fontLetterSpacing="0" fieldName="schnam" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSize="10">
        <families/>
        <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferColor="255,255,255,255" bufferSizeUnits="MM" bufferNoFill="0" bufferDraw="1" bufferOpacity="1"/>
      ...
      <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" placement="6" lineAnchorPercent="0" centroidWhole="0" offsetUnits="MapUnit" repeatDistance="0" geometryGenerator="" maxCurvedCharAngleOut="-25" preserveRotation="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" layerType="PointGeometry" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="6" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" rotationAngle="0" dist="3" yOffset="0" quadOffset="4" overrunDistance="0"/>
      <rendering displayAll="0" limitNumLabels="0" drawLabels="1" maxNumLabels="2000" obstacleFactor="1" scaleMax="10000000" obstacle="1" mergeLines="0" fontMinPixelSize="3" unplacedVisibility="0" obstacleType="0" fontMaxPixelSize="10000" minFeatureSize="0" zIndex="0" fontLimitPixelSize="0" scaleMin="1" upsidedownLabels="0" labelPerPart="0" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="'Speicher'" field="schachttyp"/>
