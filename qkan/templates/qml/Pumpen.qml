...
<qgis simplifyDrawingHints="1" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" labelsEnabled="0" simplifyDrawingTol="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Notes" readOnly="0" maxScale="0" version="3.22.16-Białowieża" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="15" name="Entwässerungssystem" field="entwart"/>
    ...
    <alias index="20" name="Sonderelementtyp" field="haltungstyp"/>
    ...
    <alias index="24" name="" field="xschob"/>
    <alias index="25" name="" field="yschob"/>
    <alias index="26" name="" field="xschun"/>
    <alias index="27" name="" field="yschun"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="sohleoben"/>
      <column type="field" width="-1" hidden="0" name="sohleunten"/>
      ...
      <column type="field" width="-1" hidden="0" name="profilnam"/>
      ...
      <column type="field" width="-1" hidden="0" name="ks"/>
