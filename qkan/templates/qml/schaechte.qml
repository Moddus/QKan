...
<qgis simplifyDrawingHints="0" minScale="3000" simplifyAlgorithm="0" simplifyMaxScale="1" symbologyReferenceScale="-1" simplifyLocal="1" labelsEnabled="1" simplifyDrawingTol="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Notes" readOnly="0" maxScale="0" version="3.22.16-Białowieża" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <rules key="{768237f4-5e8a-4ffd-91b9-7f7ae414c2f6}">
      ...
      <rule scalemaxdenom="5000" scalemindenom="500" symbol="1" key="{ffa1abd3-02c8-4574-9fb2-5c87b0e49566}"/>
      <rule scalemaxdenom="500" symbol="2" key="{7b62dc7d-874e-4d73-bd4f-7e4fb3bb6b32}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4a086b64-c675-4480-83a6-be99debb9b6e}">
      <rule scalemaxdenom="1500" description="Beschriftung Schacht" key="{2e194fba-463a-4a2c-a27a-440e869c64d5}">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" textOrientation="horizontal" legendString="Aa" namedStyle="Regular" isExpression="1" fontUnderline="0" fontStrikeout="0" fontKerning="1" blendMode="0" allowHtml="0" textOpacity="1" textColor="50,50,50,255" multilineHeight="1" fontWordSpacing="0" fontWeight="50" fontItalic="0" fontFamily="MS Shell Dlg 2" capitalization="0" fontLetterSpacing="0" fieldName="&quot;schnam&quot; || '\n' || 'D ' || &quot;deckelhoehe&quot;||'\n' || 'S ' || &quot;sohlhoehe&quot;" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontSize="10">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferColor="250,250,250,255" bufferSizeUnits="MM" bufferNoFill="1" bufferDraw="1" bufferOpacity="1"/>
            <text-mask maskType="0" maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="0" maskSizeUnits="MM" maskJoinStyle="128" maskedSymbolLayers=""/>
            <background shapeRadiiX="0" shapeSizeX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="Point" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeOffsetX="0" shapeType="0" shapeOffsetY="0" shapeRadiiUnit="Point" shapeSizeY="0" shapeOpacity="1" shapeBorderWidthUnit="Point" shapeSizeUnit="Point" shapeBorderColor="128,128,128,255" shapeDraw="0" shapeSVGFile="" shapeBlendMode="0" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeRotation="0" shapeRotationType="0">
          ...
          <text-format autoWrapLength="0" placeDirectionSymbol="0" addDirectionSymbol="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" plussign="0" useMaxLineLengthForAutoWrap="1" wrapChar="" formatNumbers="0" leftDirectionSymbol="&lt;" multilineAlign="3" decimals="3"/>
          <placement repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" lineAnchorType="0" placement="6" lineAnchorPercent="0.5" centroidWhole="0" offsetUnits="MM" repeatDistance="0" geometryGenerator="" maxCurvedCharAngleOut="-25" preserveRotation="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" layerType="PointGeometry" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="5" lineAnchorClipping="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" rotationAngle="0" dist="5" yOffset="0" quadOffset="4" overrunDistance="0"/>
          <rendering displayAll="0" limitNumLabels="0" drawLabels="1" maxNumLabels="2000" obstacleFactor="1" scaleMax="0" obstacle="1" mergeLines="0" fontMinPixelSize="3" unplacedVisibility="0" obstacleType="1" fontMaxPixelSize="10000" minFeatureSize="0" zIndex="0" fontLimitPixelSize="0" scaleMin="0" upsidedownLabels="0" labelPerPart="0" scaleVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option name="properties"/>
          ...
          <callout type="simple">
            <Option type="Map">
              ...
              <Option value="3" type="double" name="minLength"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="dbname='itwh.sqlite' table=&quot;entwaesserungsarten&quot;" type="QString" name="LayerSource"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="eigentum_a1c903df_4af8_4ecf_9da6_8892afa11450" type="QString" name="Layer"/>
            <Option value="Eigentum" type="QString" name="LayerName"/>
            <Option value="spatialite" type="QString" name="LayerProviderName"/>
            <Option value="dbname='itwh.sqlite' table=&quot;eigentum&quot;" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="true" type="bool" name="UseCompleter"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="Knotentypen" type="QString" name="LayerName"/>
            <Option value="spatialite" type="QString" name="LayerProviderName"/>
            <Option value="dbname='itwh.sqlite' table=&quot;knotentypen&quot;" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="true" type="bool" name="UseCompleter"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="Schachttypen" type="QString" name="LayerName"/>
            <Option value="spatialite" type="QString" name="LayerProviderName"/>
            <Option value="dbname='itwh.sqlite' table=&quot;schachttypen&quot;" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="true" type="bool" name="UseCompleter"/>
  ...
  <aliases>
    ...
    <alias index="1" name="Schachtname" field="schnam"/>
    <alias index="2" name="Sohlhöhe" field="sohlhoehe"/>
    <alias index="3" name="Deckelhöhe" field="deckelhoehe"/>
    <alias index="4" name="Durchmesser" field="durchm"/>
    <alias index="5" name="Druckdicht" field="druckdicht"/>
    <alias index="6" name="Überstaufläche" field="ueberstauflaeche"/>
    <alias index="7" name="Entwässerungssystem" field="entwart"/>
    <alias index="8" name="Straße" field="strasse"/>
    <alias index="9" name="" field="baujahr"/>
    <alias index="10" name="Eigentümer" field="eigentum"/>
    <alias index="11" name="Teilgebiet" field="teilgebiet"/>
    <alias index="12" name="Knotentyp" field="knotentyp"/>
    <alias index="13" name="Auslasstyp" field="auslasstyp"/>
    <alias index="14" name="Schachttyp" field="schachttyp"/>
    <alias index="15" name="Planungsstatus" field="simstatus"/>
    <alias index="16" name="Material" field="material"/>
    <alias index="17" name="" field="xsch"/>
    <alias index="18" name="" field="ysch"/>
    <alias index="19" name="Kommentar" field="kommentar"/>
    <alias index="20" name="erstellt" field="createdat"/>
    <alias index="21" name="" field="geom"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="pk"/>
    <default applyOnUpdate="0" expression="" field="schnam"/>
    <default applyOnUpdate="0" expression="" field="sohlhoehe"/>
    <default applyOnUpdate="0" expression="" field="deckelhoehe"/>
    <default applyOnUpdate="0" expression="" field="durchm"/>
    <default applyOnUpdate="0" expression="" field="druckdicht"/>
    <default applyOnUpdate="0" expression="" field="ueberstauflaeche"/>
    ...
    <default applyOnUpdate="0" expression="" field="auslasstyp"/>
    <default applyOnUpdate="0" expression="" field="schachttyp"/>
    <default applyOnUpdate="0" expression="" field="simstatus"/>
    <default applyOnUpdate="0" expression="" field="material"/>
    <default applyOnUpdate="0" expression="" field="xsch"/>
    <default applyOnUpdate="0" expression="" field="ysch"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="sohlhoehe" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="deckelhoehe" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="ueberstauflaeche" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="knotentyp" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="auslasstyp" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="schachttyp" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="xsch" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="ysch" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" field="geom" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="sohlhoehe"/>
      <column type="field" width="-1" hidden="0" name="deckelhoehe"/>
      <column type="field" width="-1" hidden="0" name="durchm"/>
      <column type="field" width="-1" hidden="0" name="druckdicht"/>
      <column type="field" width="-1" hidden="0" name="ueberstauflaeche"/>
      <column type="field" width="-1" hidden="0" name="entwart"/>
      <column type="field" width="-1" hidden="0" name="strasse"/>
      <column type="field" width="-1" hidden="0" name="teilgebiet"/>
      <column type="field" width="-1" hidden="0" name="knotentyp"/>
      <column type="field" width="-1" hidden="0" name="auslasstyp"/>
      <column type="field" width="-1" hidden="0" name="schachttyp"/>
      <column type="field" width="-1" hidden="0" name="simstatus"/>
      <column type="field" width="-1" hidden="0" name="material"/>
      <column type="field" width="-1" hidden="0" name="xsch"/>
      <column type="field" width="-1" hidden="0" name="ysch"/>
      <column type="field" width="-1" hidden="0" name="kommentar"/>
      <column type="field" width="-1" hidden="0" name="createdat"/>
      <column type="field" width="-1" hidden="0" name="geom"/>
